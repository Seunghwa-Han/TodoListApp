...
public class Menu {
    ...
    public static void displaymenu()
    {
        ...
        System.out.println("6. 이름순으로 정렬 ( ls_name_asc )");
        System.out.println("7. 이름 역순으로 정렬 ( ls_name_desc )");
        System.out.println("8. 날짜 순으로 정렬 ( ls_date )");
        System.out.println("9. 최신 순으로 정렬 ( ls_date_desc ) ");
        System.out.println("10. 검색 ( find <키워드> )");
